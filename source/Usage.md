...
2. Download the tool as a desktop application for offline use (can be used without network). [Download](https://s.wtsolutions.cn/latest.html?product=sheet-to-doc&language=en)
3. Use the addin version in Excel or WPS. [Download](Download.md#addin)
